...
fn select_validators(
    ...
    if validators.len() == max_number_selected {
        ...
        // smallest stake
        let threshold = (validators.last().unwrap().stake() + 1) * 8 / 10;    // TODO : 중요!! 프로토콜 중 여기를 수정했음. 검증자 수를 20% 줄임
        // let threshold = (validators.last().unwrap().stake() + 1);     // 원본
        // println!("==================================================");
        // println!("==================================================");
        // println!("==================================================");
        // println!("==================================================");
        ...
        // println!("      threshold* 8 / 10 : {}", threshold * 8 / 10);
        // println!("==================================================");
        // println!("==================================================");
        // println!("==================================================");
        // println!("==================================================");
        ...
        let threshold = if checked_feature!(
            ...
            ((min_stake_ratio * Ratio::from_integer(total_stake)
                ...
                .ceil()
                .to_integer()) * 8 / 10    // TODO : 중요!! 프로토콜 중 여기를 수정했음. 검증자 수를 20% 줄임
        } else {
            ((min_stake_ratio * Ratio::new(total_stake, 1)).ceil().to_integer()) * 8 / 10    // TODO : 중요!! 프로토콜 중 여기를 수정했음. 검증자 수를 20% 줄임
        };
        ...
        //         .to_integer()) // 원본
        // } else {
        //     ((min_stake_ratio * Ratio::new(total_stake, 1)).ceil().to_integer()) * 8 / 10     // 원본
        // };
        // println!("==================================================");
        // println!("==================================================");
        // println!("==================================================");
